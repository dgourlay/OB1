...
A 2,000-conversation export typically yields 3,000-5,000 thoughts. From a real production run with ~2 years of ChatGPT history:

| Metric | Value |
|--------|-------|
| Conversations scanned | 2,341 |
| Filtered as trivial | ~1,000 (43%) |
| Processed | ~1,400 |
| Thoughts generated | ~4,200 |
| Estimated API cost | ~$1.10 |

Each thought includes structured metadata:

```json
{
  "content": "[ChatGPT: High Chair Recommendations 2026 | 2026-01-03] Chose Nuna ZAAZ high chair for hardwood floors. Key criteria: wide stable base with rubber feet, easy-clean seat, grows from 6mo to 250lbs. Rejected Stokke Tripp Trapp (overpriced, narrow base), IKEA Antilop (flimsy on hardwood, no footrest).",
  "metadata": {
    "source": "chatgpt",
    "type": "decision",
    "topics": ["baby gear", "high chair"],
    "people": [],
    "confidence": "firm",
    "chatgpt_model": "gpt-5-2-thinking",
    "chatgpt_message_count": 88,
    "chatgpt_conversation_type": "product_research",
...
|------|-----------------|---------|
| `decision` | A choice made with reasoning | "Chose Nuna ZAAZ high chair for hardwood. Rejected Stokke (overpriced), IKEA Antilop (unstable)." |
...
| `context` | People, projects, situations | "Team builds fleet tech at Amazon — hardware on logistics trailers. Separate team handles yard automation." |
